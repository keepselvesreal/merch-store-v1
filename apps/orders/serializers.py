...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    # orders/serializers.py 내 OrderItemSerializer
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'total_price', 'payment_method', 'cash_receipt_type', 'cash_receipt_number',
            'created_at', 'updated_at', 'items', 'items_data'
        ]
        read_only_fields = ['order_number', 'order_token', 'total_price', 'created_at', 'updated_at']
